      ...
      <div class="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
        <form action="#" enctype="multipart/form-data" class="space-y-4">
          <div>
            ...
            <input class="w-full rounded-lg bg-gray-300 border-black p-3 text-sm" placeholder="What is your event's Name?"
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div>
              ...
              <input class="w-full rounded-lg  bg-gray-300 border-black p-3 text-sm" placeholder="Venue" type="text"
                id="email" v-model="form.venue" />
            </div>

            <div>
              <label for="phone">Capacity</label>
              <input class="w-full rounded-lg  bg-gray-300 border-black p-3 text-sm" placeholder="Capacity" type="text"
                id="phone" v-model="form.capacity" />
            </div>
            <div>
              <label for="phone">Price</label>
              <input class="w-full rounded-lg  bg-gray-300 border-black p-3 text-sm" placeholder="Price" type="text"
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              ...
              <input type="file" ref="image" id="image" @change="imageUploaded" />
            </div>
          ...
          <div>
            ...
            <textarea class="w-full rounded-lg  bg-gray-300 border-black p-3 text-sm" placeholder="Description" rows="8"
              id="message" v-model="form.description"></textarea>
          </div>
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
              <label for="start">Starting date </label>
              <input class="w-full rounded-lg  bg-gray-300 border-black p-3 text-sm" type="datetime-local" id="start"
                v-model="form.start" />
            </div>

            <div>
              <label for="end">End Date </label>
              <input class="w-full rounded-lg  bg-gray-300 border-black p-3 text-sm" type="datetime-local" id="end"
                v-model="form.end" />
            </div>
          </div>
          <div class="mt-4">
